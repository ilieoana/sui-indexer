...
import { handleProjectEvents } from '../handlers/project';
import { handleUsernameRegistryEvents } from '../handlers/usernameRegistry';
...
const EVENTS_TO_TRACK: EventTracker[] = [
  {
    type: `${CONFIG.CONTRACT.packageId}::project`,
    filter: {
      MoveEventModule: {
        module: 'project',
    ...
    callback: handleProjectEvents,
  },
  {
    type: `${CONFIG.CONTRACT.packageId}::username_registry`,
    filter: {
      MoveEventModule: {
    ...
    callback: handleUsernameRegistryEvents,
  }
];
